...
<div class="register-container">
    ...
    <div class="left-box">
        ...
        <img src="<?php echo e(asset('assets/images/daily.png')); ?>" alt="Logo">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature()): ?>
                <div class="terms">
                    ...
                    <label>
                        ...
                        I agree to the
                        <a target="_blank" href="<?php echo e(route('terms.show')); ?>">
                            Terms of Service
                        </a>
                        and
                        <a target="_blank" href="<?php echo e(route('policy.show')); ?>">
                            Privacy Policy
                        </a>
...
</html><?php /**PATH C:\Users\hp\Ecommerce\resources\views/auth/register.blade.php ENDPATH**/ ?>