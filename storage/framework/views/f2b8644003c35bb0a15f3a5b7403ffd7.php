...
<table class="cart-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <input type="hidden" name="product_title[]" value="<?php echo e($item->product_title); ?>">
            ...
            <td>
                <a href="<?php echo e(url('remove_cart', $item->id)); ?>" class="btn btn-danger btn-sm">
                    Remove
                </a>
            </td>
...
<div style="width:80%; margin:auto; text-align:right; margin-top:20px; font-size:18px; font-weight:bold; color:#333;">
    Total Amount: ₱<?php echo e($totalAmount); ?>
...
</html><?php /**PATH C:\Users\hp\Ecommerce\resources\views/user/showcart.blade.php ENDPATH**/ ?>